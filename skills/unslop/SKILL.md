...
1. Rewrite. Preserve meaning, match intended tone.
1. Add soul (see next section).
1. Self-audit: "What makes this obviously AI generated?" Fix remaining tells.
...
1. **Puffery.** "pivotal moment", "testament to", "evolving landscape", "setting
   ...
   happened.
1. **Name-dropping.** Listing media outlets without context. Pick one, say what
   was said.
1. **Superficial -ing phrases.** "highlighting...", "ensuring...",
   "reflecting...", "showcasing...", "fostering...". Delete or expand with real
   sources.
1. **Promotional language.** "nestled", "vibrant", "breathtaking",
   "groundbreaking", "renowned", "stunning", "must-visit". Use neutral
   descriptions.
1. **Vague attributions.** "Experts believe", "Industry reports suggest", "Some
   critics argue". Name the source or delete.
1. **Formulaic challenges.** "Despite challenges... continues to thrive."
...
7. **AI vocabulary.** Additionally, crucial, delve, enduring, enhance,
   ...
   plain words.
1. **Fancy ways to say "is".** "serves as", "stands as", "boasts", "features".
   Just say "is" or "has".
1. **"Not just X, but Y."** State the point directly instead.
1. **Rule of three.** Forcing ideas into groups of three. Use the natural
   number.
1. **Synonym cycling.** Protagonist, main character, central figure, hero all in
   one paragraph. Pick one, repeat it.
1. **False ranges.** "from X to Y" where X and Y aren't on a meaningful scale.
...
01. **Colon overuse.** Colons are fine before a list or example. Not as
...
01. **Boldface overuse.** Don't bold every proper noun or acronym.
01. **Inline-header lists.** The tell is a bold label and colon that restates
    ...
    by genuinely new detail ("**Schema in TypeScript.** Tables live in one
    file.") is fine, not a tell.
01. **Title case headings.** Use sentence case.
01. **Decorative emojis.** Remove from headings and bullets.
01. **Curly quotes.** Replace with straight quotes.

### Communication artifacts

20. **Chatbot phrases.** "I hope this helps!", "Let me know if...", "Of
    course!", "Certainly!", "Found the smoking gun!" Remove.
01. **Cutoff disclaimers.** "While specific details are limited..." Find sources
    or remove.
01. **Sycophantic tone.** "Great question! You're absolutely right!" Respond
    directly.
...
01. **Excessive hedging.** "could potentially possibly be argued that it might"
    becomes "may".
01. **Generic conclusions.** "The future looks bright." State specific plans or
    facts.
...
26. **Abstract metaphor nouns.** Substrate, wedge, vector, locus, vantage,
    ...
    only tightens". "Evacuate" becomes "move out". "Endgame" becomes "the last
    phase". Pick the concrete word.
...
27. **Say what it does, not how it feels.** "the database stays close at hand",
    ...
    names the mechanism or a number: "`.toSQL()` returns the exact string sent
...
01. **Shorten or split dense sentences.** If the reader has to backtrack to
    parse a sentence, break it in two or drop clauses. One idea per sentence.
01. **Active voice.** Prefer it. Catch "is/are/was/were + past participle" and
    ...
    matter.
01. **Cut adverbs, or use a stronger verb.** "runs quickly" becomes "is fast" or
    the number. "significantly improves" becomes the measured delta. An adverb
    propping up a weak verb means the verb is wrong.
01. **Prefer the plain word.** "utilize" becomes "use", "leverage" becomes
